...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<link rel="stylesheet" href="css/stylefaq.css"> <!-- Resource style -->
        <link rel="stylesheet" href="css/cssforsearch.css"><!---Search style -->
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
	<title>FAQ Template | CodyHouse</title>
</head>
<body>
    <a href="postnewquery.jsp"> Post New Query</a>
    <header>
<div class="flexsearch">
		<div class="flexsearch--wrapper">
			<form class="flexsearch--form" action="searchquery.jsp" method="post">
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" placeholder="search">
                                        <a href="#"> Post New Query</a>
				</div>
